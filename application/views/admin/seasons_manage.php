    ...
    <div class="row">
        <div class="col-sm-12">
            <a class="btn btn-sm btn-primary waves-effect" href="<?php echo base_url('admin/tvseries'); ?>"> <span class="btn-label"><i class="fa fa-arrow-left"></i></span>Back to List</a>
                ...
                <button data-toggle="modal" data-target="#mymodal" data-id="<?php echo base_url() . 'admin/view_modal/seasons_add/'.$param1;?>" id="menu" class="btn btn-sm btn-primary waves-effect waves-light"><span class="btn-label"><i class="fa fa-plus"></i></span>Add Years</button>
                <br>
                <br>
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr id='row_<?php echo $seasons['seasons_id'];?>'>
                            ...
                            <td><?php echo $this->common_model->get_total_episods_by_seasons_id($seasons['seasons_id']);?> Posters</td>
                            <td>
                                <a class="btn btn-primary btn-sm" href="<?php echo base_url().'admin/episodes_manage/'.$param1.'/'.$seasons['seasons_id']; ?>">Manage Posters</a>
