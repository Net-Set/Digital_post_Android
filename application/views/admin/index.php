...
<head>
    ...
    <meta name="copyright" content="Copyright (c) 2020 - 2021 Infiapp">
...
<body class="app sidebar-mini rtl <?php //if(isset($page_name) && ($page_name=='videos_add' || $page_name=='videos_edit'|| $page_name=='videos_manage')){ echo 'sidebar-collapse';}  ?>">    
    ...
    <header class="app-header hidden-print"><a class="app-header__logo" href="<?php echo base_url(); ?>">
        <img src="<?php echo base_url(); ?>assets/images/logo.png" alt="postermaker" height="30" style="margin-top:-15px;"></a>
    ...
    <footer class="footer text-right"> <?php echo date("Y"); ?> &copy; <a href="https://codecanyon.net/user/infiapp">DigitalPost - V<?php echo $this->db->get_where('config' , array('title' =>'version'))->row()->value; ?></a> |
  Developed by: <a href="https://codecanyon.net/user/infiapp">Infiapp Solution</a></footer>
   <!-- ajax modal  -->
