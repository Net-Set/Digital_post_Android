...
<div class="form-group">
  ...
  <input type="text"  name="headings" value="<?php echo "New - ".$row['title']; ?>" class="form-control" placeholder="Enter notification title" />
</div>
<div class="form-group">
  <label class="control-label">Message</label>
    <textarea  rows="5" name="message" class="form-control"  placeholder="Enter your message"><?php echo "See ".$row['title']." on ".$site_name; ?></textarea>
</div>
<?php endforeach; ?>
<div class="form-group">
