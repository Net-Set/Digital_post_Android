...
<div class="form-group">
    ...
    <div class="col-sm-12">
        <select class="form-control m-bot15" name="action_type" id="action_type">
          <!--<option value="movie" <?php if($row['action_type']=='movie'): echo "selected"; endif; ?>>Upcoming</option>-->
          <option value="tvseries" <?php if($row['action_type']=='tvseries'): echo "selected"; endif; ?>>Open in app</option>
          <!--<option value="tv" <?php if($row['action_type']=='tv'): echo "selected"; endif; ?>>Upcoming</option>-->
          <!--<option value="external_browser" <?php if($row['action_type']=='external_browser'): echo "selected"; endif; ?>>Upcoming</option>-->
          <option value="webview" <?php if($row['action_type']=='webview'): echo "selected"; endif; ?>>Open in web</option>
        </select>
    </div>
</div>
...
<div class="form-group" id="tvseries" <?php if($row['action_type'] !='tvseries'): echo 'style="display: none;"'; endif; ?>>
  <label class="control-label col-md-12">Sub category</label>
  <div class="col-sm-12">
