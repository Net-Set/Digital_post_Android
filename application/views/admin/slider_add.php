...
<div class="form-group">
    ...
    <div class="col-sm-12">
        <select class="form-control m-bot15" name="action_type" id="action_type">
          <!--<option value="movie">Upcoming</option>-->
          <option value="tvseries" selected>Open in app</option>
          <!--<option value="tv">Upcoming</option>-->
          <!--<option value="external_browser">Upcoming</option>-->
          <option value="webview" >Open in web</option>
        </select>
    </div>
</div>
...
<div class="form-group" id="tvseries" >
