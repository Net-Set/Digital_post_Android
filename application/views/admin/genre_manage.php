...
<div class="card">
    <div class="row">
        <div class="col-sm-12">
            <button data-toggle="modal" data-target="#mymodal" data-id="<?php echo base_url() . 'admin/view_modal/genre_add';?>" id="menu" class="btn btn-sm btn-primary waves-effect waves-light"><span class="btn-label"><i class="fa fa-plus"></i></span>Add Category</button>
            <br>
            <br>
                        ...
                        <!--<td>
                            <?php
                                if($genre['featured']=='1'){
                                    ...
                                    echo '<span class="label label-primary label-xs">None Featured</span>';
                                }
                            ?>
                        </td>-->
                        <td>
