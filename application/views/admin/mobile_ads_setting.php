        ...
        <div class="col-lg-12">
            <div class="panel panel-border panel-primary">
              ...
              <!--  <div class="form-group row">
                ...
                <div class="form-group row">
                    <label class="col-sm-3 control-label">Admob Open ID</label>
                    <div class="col-sm-3">
               ...
               <!-- <strong>Facebook Audance Network</strong>
                ...
                <div class="form-group row">
                    <label class="col-sm-3 control-label">Admob Native Ads Placement ID</label>
                    <div class="col-sm-3">
                ...
                <div class="form-group row">
                    <label class="col-sm-3 control-label">Ads Clicks</label>
                    <div class="col-sm-3">
                      <input type="text"  value="<?php echo $fan_banner_ads_placement_id;?>" data-parsley-minlength="1" name="fan_banner_ads_placement_id" class="form-control" required  />
                    </div>
                </div>
